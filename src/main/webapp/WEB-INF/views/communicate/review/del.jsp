...
<html>
	...
	<body>
		...
		<main id="delete-review">
			<h1>리뷰 삭제</h1>
			
			<form method="POST" action="/ddstudio/communicate/reviewdel.do?seq=${seq}" name="delete-form">				
				<table>
					<tr>
						<td>
		...
		<script>
	        ...
	        $('#back-button').click(function () {
	        	location.href='/ddstudio/communicate/reviewdetail.do?seq=${seq}';
	        });
	    </script>
	</body>
</html>