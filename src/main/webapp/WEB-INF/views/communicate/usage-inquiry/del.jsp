...
<html>
	...
	<body>
		...
		<main id="delete-inquiry">
			<h1>이용문의 삭제</h1>
			
			<form method="POST" action="/ddstudio/communicate/usageinquirydel.do?seq=${seq}" name="delete-form">				
				<table>
					<tr>
						<td>
		...
		<script>
	        ...
	        $('#back-button').click(function () {
	        	location.href='/ddstudio/communicate/usageinquirydetail.do?seq=${seq}';
	        });
	    </script>
	</body>
</html>