...
<body>
	...
	<main id="main">
		...
		<div id="content">
			<div class="wide-item">
				<form method="POST" action="/ddstudio/shop/restaurant/edit.do" enctype="multipart/form-data">
					<table>
						<!-- 식당명 필드 -->
						<tr>
							...
							<td>
								<div>
									<input type="text" name="menu" id="menu" required
										class="middle-flat" value="${dto.menu}">
								</div>
							</td>
						</tr>
						<!-- 운영 시간 필드 -->
							...
							<td>
								<div>
									<input type="time" name="start-time" id="start-time" required
										class="short-flat" value="${dto.start_date}"> <input type="time" name="end-time"
										id="end-time" required class="short-flat" value="${dto.end_date}">
								</div>
							</td>
						</tr>
						<!-- 이름 필드 -->
							...
							<td>
								<div>
									<input type="number" name="capacity" id="capacity" required
										class="middle-flat" value="${dto.capacity}">
								</div>
							</td>
						</tr>
						<!-- 연락처 필드 -->
						<tr>
							...
							<td>
								<div>
									<input type="text" name="tel" id="tel" required class="middle-flat" value="${dto.tel}">
								</div>
							</td>
						</tr>
						<!-- 위치 필드 -->
							...
							<td>
								...
								<select name="category" id="category">
									<c:forEach items="${list}" var="pdto">
										<c:if test="${pdto.category_seq eq dto.category_seq}">
											<option value="${pdto.category_seq}" selected>${pdto.name}</option>
										</c:if>
										<c:if test="${pdto.category_seq ne dto.category_seq}">
											<option value="${pdto.category_seq}">${pdto.name}</option>
										</c:if>
									</c:forEach>
								</select>
								</div>
							...
							<td>
								<div class="button-container">
									...
									<button type="button" id="cancel" class="button"
										onclick="location.href='/ddstudio/shop/restaurant/detail.do?seq=${dto.restaurant_seq}';">취소</button>
								</div>
							</td>
						</tr>
					</table>
					...
					<input type="hidden" name="restaurant_seq" value="${dto.restaurant_seq}">
				</form>
			</div>
		</div>
	</main>
