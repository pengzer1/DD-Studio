                        ...
                        <div class="nav-item nav-link index-navi">
							...
							<div class="nav-menu-name">소통</div>
                                <div class="sub-menu">
                                    ...
                                    <div><a href="/ddstudio/communicate/faq.do?type=이용정보">FAQ</a></div>
                                    <div><a href="/ddstudio/communicate/review.do">리뷰</a></div>
                                    <div><a href="/ddstudio/communicate/usageinquiry.do">고객소리함</a>
                                    <div class="sub-sub-menu">
                                    	<div><a href="/ddstudio/communicate/usageinquiry.do">이용문의</a></div>
                                    	<div><a href="/ddstudio/communicate/voc.do">칭찬/불편/건의</a></div>
