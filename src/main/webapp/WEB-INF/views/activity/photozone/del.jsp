...
<body>
	<!-- /ddstudio/activity/photozone/del.jsp -->
	...
	<main id="attraction-del">
		...
		<div id="sub-title">
			<p class="--bs-red"><i class="fa-solid fa-triangle-exclamation"></i>주의사항<i class="fa-solid fa-triangle-exclamation"></i></p>
					<p>하단의 삭제버튼을 누르는 즉시 포토존은 삭제 처리 되며, 하기 내용의 업무가 더이상 불가능하게됩니다.</p>
				<!-- <div class="del-box">
					<p>1. 위치/테마 정보 조회에서 해당 어트랙션 조회가 불가합니다.</p>
					<p>1. 해시태그 조회에서 해당 페스티벌 조회가 불가합니다.</p>
				</div> -->
			<p>정말로 선택하신 포토존을 삭제하시겠습니까?</p>
		</div>
		
		<div id="del-content">
			<form method="POST" action="/ddstudio/activity/photozonedel.do">
				<div id="btn">
					<button type="button" onclick="location.href= '/ddstudio/activity/photozonedetail.do?seq=' + ${seq};"><i class="fa-solid fa-circle-arrow-left"></i>취소</button>
