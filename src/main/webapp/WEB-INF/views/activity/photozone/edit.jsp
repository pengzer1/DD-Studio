...
<body>
	<!-- /ddstudio/activity/photozone/edit.jsp -->
	...
	<div id="content">
			<div class="wide-item">
				<form method="POST" action="/ddstudio/activity/photozoneedit.do" enctype="multipart/form-data" onsubmit="return true;" id="form">
					<table>
						<!-- 포토존명 필드 -->
						<tr>
							...
							<td>
								<div>
									<input type="text" name="name" id="name" class="middle-flat" placeholder="포토존명을 입력해주세요." value="${dto.name}" required>
								</div>
							</td>
						</tr>
						<!-- 시간 필드 -->
