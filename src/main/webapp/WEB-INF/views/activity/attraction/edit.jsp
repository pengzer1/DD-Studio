...
<body>
	...
	<main id="attraction-add">
		...
		<!-- <div id="add-content"> -->
			<form method="POST" action="/ddstudio/activity/attractionadd.do" class="add-form">
				<table class="add-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<div>
									<input type="text" name="time"  placeholder="HH:MM - HH:MM 형식으로 작성해주세요." value="${dto.time}"/>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div>
									<input type="number" name="capacity"  placeholder="숫자 형식으로 작성해주세요." min="1" value="${dto.capacity}" />
								</div>
							</td>
							<!-- 올바르지 않은 형식을 입력 시 warning message가 출력될 부분 -->
							<td></td>
						...
						<tr>
							...
							<td>
								<div>
									<textarea name="restriction" placeholder="제한사항 등 해당 어트랙션의 이용정보를 작성해주세요.">${dto.restriction}</textarea>
								</div>
							</td>
						</tr>
						<tr>
