		...
		<div id="content">			
			<div class="munti-content-container">
				<div class="item">
					...
					<div><button type="button" onclick="location.href='/ddstudio/admin/theme/add.do';">테마 추가</button></div>
				</div>
				<div class="item">
					<img src="/ddstudio/asset/image/토토로.png" alt="토토로 이미지" class="totoro-image">
					<div><button type="button" onclick="location.href='/ddstudio/admin/theme/edit.do';">테마 수정</button></div>
				</div>
				<div class="item">
					<img src="/ddstudio/asset/image/토토로.png" alt="토토로 이미지" class="totoro-image">
					<div><button type="button" onclick="location.href='/ddstudio/admin/theme/del.do';">테마 삭제</button></div>
				</div>
			</div>
		</div>
	</main>
